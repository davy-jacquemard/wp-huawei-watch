...
/***/ "./static/scripts/components/_accordions.js":
/*!**************************************************!*\
  !*** ./static/scripts/components/_accordions.js ***!
  \**************************************************/
/***/ (function() {
...
function close(current = null) {
  accordions.forEach(accordion => {
    if (current !== accordion && !canOpenMultiple || current === accordion && canOpenMultiple) {
      ...
      content.style.height = `${content.scrollHeight}px`; //content.style.paddingBottom = `0`;
...
function open(el) {
  ...
  content.style.height = `${content.scrollHeight}px`; //  content.style.paddingBottom = `16px`;
...
let newsSlider = new swiper__WEBPACK_IMPORTED_MODULE_1__.default(settings.newsSliderSelector, {
  slidesPerView: 'auto',
  spaceBetween: 16,
  pagination: {
...
let instaSlider = new swiper__WEBPACK_IMPORTED_MODULE_1__.default(settings.instaSliderSelector, {
  slidesPerView: 'auto',
  spaceBetween: 24,
  loop: true,
  loopedSlides: 10,
...
let appImagesSlider = new swiper__WEBPACK_IMPORTED_MODULE_1__.default(settings.appImagesSliderSelector, {
  slidesPerView: 1,
  spaceBetween: 0,
  effect: 'fade',
  navigation: {
